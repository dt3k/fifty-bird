...
-- set the gap height variable to be local to this class
local randomGapHeight = 0
...
function PipePair:init(y)
    ...
    -- generate a random gap height with a min of 80 and a max of 130
    randomGapHeight = love.math.random(80,130)

    -- instantiate two pipes that belong to this pair
    self.pipes = {
        ['upper'] = Pipe('top', self.y),
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + randomGapHeight)
    }
